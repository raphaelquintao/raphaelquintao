...
- **[Qolor](https://github.com/raphaelquintao/Qolor)** - Build harmonious Firefox themes using an OKLCH color engine.
  > *I wanted a Firefox theme. Almost everything I found was "almost" it. Then the problem escalated into a color engine.*

- **[QColor](https://github.com/raphaelquintao/QColor)** - Smart Sublime Text color highlighter, converter and picker.
...
- **[EyeSaver](https://github.com/raphaelquintao/EyeSaver)** - Windows display color temperature utility.
...
- **[PureVision](https://github.com/raphaelquintao/PureVision)** - GTK theme.
...
- **[QRedshiftCinnamon](https://github.com/raphaelquintao/QRedshiftCinnamon)** / **[QRedshift](https://github.com/raphaelquintao/QRedshift)** - Linux display color temperature utility.
  > *I wanted a few sliders so I could stop typing `redshift -O 4500 -p`. I couldn't find an interface I liked, so I built an almost dependency-free, stateless Redshift alternative in ANSI C with its own gamma-ramp algorithms and state reconstruction. The sliders are smoother than ever.*


- **[QCarLauncher](https://github.com/raphaelquintao/QCarLauncherPreview)** - Android launcher built from scratch for automotive head units.
...
- **[QAudioVisualizer](https://github.com/raphaelquintao/QAudioVisualizer)** - Lightweight GTK audio visualizer.
